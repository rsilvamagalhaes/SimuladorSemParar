...
public class ConsultaclienteResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the cliente value for this ConsultaclienteResponse.
     * 
     * @return cliente
     */
    ...
    /**
     * Sets the cliente value for this ConsultaclienteResponse.
     * 
     * @param cliente
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://simuladorsemparar.com.br/cliente/", ">consultaclienteResponse"));
