...
public class ValidarclienteRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the cliente value for this ValidarclienteRequest.
     * 
     * @return cliente
     */
    ...
    /**
     * Sets the cliente value for this ValidarclienteRequest.
     * 
     * @param cliente
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://simuladorsemparar.com.br/cliente/", ">validarclienteRequest"));
